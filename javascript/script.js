 // Get references to key elements
         ...
         */
        const createNewKanbanItem = (itemText) => {
            itemCounter++;
            ...
            newItem.innerHTML = `
                <span class="kanban-item-content" contenteditable="true">${itemText}</span>
            ...
            `;
            const firstColumn = kanbanContainer.querySelector('.column');
            if (firstColumn) {
